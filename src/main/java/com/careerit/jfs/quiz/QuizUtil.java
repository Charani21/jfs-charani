...
public class QuizUtil {
    public static List<Question> getGKQuestions(){
        ...
        Question q5 = new Question(5,
                "Whats is the capital of Kerala?",
                List.of("Kochi","Trivandrum","Kozhikode","Kannur"),2);
        return List.of(q1,q2,q3,q4,q5);
    }
    public static List<Question> getJavaQuestions(){
        Question q1 = new Question(1,"Which of the following is a not a keyword in Java?" ,
                List.of("class","interface" ,"extends" ,"abstraction"),4);
        Question q2 = new Question(2,"Which of the following is a not a valid identifier in Java?",
                List.of("abc","123","abc123","abc_123"),2);
        Question q3 = new Question(3,"Which of the following is a not a valid data type in Java?",
                List.of("int","float","double","string"),4);
        Question q4 = new Question(4,"Which of the following is a not a valid access modifier?",
                List.of("public","protected","default","private"),4);
        Question q5 = new Question(5,"Which of the following is a valid loop in Java?",
